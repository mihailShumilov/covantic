 ...
 *
 * Generated from `packages/anchor/target/idl/covantic.json`. Regenerate with
 * `pnpm idl:sync` after any change to the program's instructions, accounts or
 * events — a stale copy here builds wrong instructions from the browser.
 */
