...
export default function ClaimsPage() {
  ...
  return (
    <div style={{ padding: 'var(--space-xl)', maxWidth: 1200, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: 'var(--space-xl)' }}>Claims Feed</h1>
              ...
              {claims.map((claim) => (
                <div
                  ...
                  style={{
                    ...
                    background: selectedClaim?.id === claim.id ? 'var(--color-surface-hover)' : 'var(--color-bg)',
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                    ...
                    <Badge variant={statusVariants[claim.status] ?? 'neutral'}>{claim.status}</Badge>
                  </div>
